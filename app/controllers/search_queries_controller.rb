class SearchQueriesController < ApplicationController
  ...
  private
    ...
    def search_query_params
      params.require(:search_query).permit(:date_range, :author, :credibility_rate, :research_method_field1, :research_method_field2, :research_method_field3, :research_method_field4, :se_method, :research_metric, :participant1, :participant2, :participant3, :participant4)
    end
end
